                  ...
                  <td class="px-6 py-4">
                    <div class="flex items-center gap-2">
                      ...
                      <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                        ...
                        {task.status === 'Not Started' ? 'bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-300' : ''}
                        {task.status === 'Waiting on someone else' ? 'bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-300' : ''}
                        {task.status === 'Deferred' ? 'bg-pink-100 dark:bg-pink-900/30 text-pink-800 dark:text-pink-300' : ''}
                      ">
                        {task.status || 'N/A'}
                      </span>
                    </div>
              ...
              <div class="flex flex-wrap gap-2 mb-3">
                <div class="flex items-center gap-1">
                  ...
                  <span class="text-xs px-2 py-1 rounded-full font-medium
                    ...
                    {task.status === 'Not Started' ? 'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300' : ''}
                    {task.status === 'Waiting on someone else' ? 'bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300' : ''}
                    {task.status === 'Deferred' ? 'bg-pink-100 dark:bg-pink-900/30 text-pink-700 dark:text-pink-300' : ''}
                  ">
                    {task.status || 'N/A'}
                  </span>
                </div>
