      ...
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between py-6">
        <div class="flex items-center gap-4">
          {#if primaryAccountRel}
            <a href="/app/accounts/{primaryAccountRel.account.id}" class="text-gray-500 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400 flex items-center transition-colors">
              <ArrowLeft class="w-5 h-5 mr-2" />
              Back to {primaryAccountRel.account.name}
            </a>
          {:else}
            <a href="/app/contacts" class="text-gray-500 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400 flex items-center transition-colors">
              <ArrowLeft class="w-5 h-5 mr-2" />
              Back to Contacts
            </a>
          {/if}
            ...
            <div class="space-y-4">
              {#each contact.accountRelationships as relationship}
                <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-600">
                  <div class="flex-1">
                    <div class="flex items-center gap-3">
                      <a href="/app/accounts/{relationship.account.id}" class="font-medium text-gray-900 dark:text-white hover:text-blue-600 dark:hover:text-blue-400 flex items-center gap-2">
        ...
        {#if contact.opportunities && contact.opportunities.length > 0}
          <div class="bg-white dark:bg-gray-800 shadow-sm rounded-xl p-6 border border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between mb-6">
              ...
              <a href="/app/opportunities?contact={contact.id}" class="text-sm text-blue-600 dark:text-blue-400 hover:underline flex items-center gap-1">
                View all
            ...
            <div class="space-y-4">
              {#each contact.opportunities as opp}
                <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                  <div class="flex-1">
                    <a href="/app/opportunities/{opp.id}" class="font-medium text-gray-900 dark:text-white hover:text-blue-600 dark:hover:text-blue-400">
                      {opp.name}
                    </a>
        ...
        {#if contact.tasks && contact.tasks.length > 0}
          <div class="bg-white dark:bg-gray-800 shadow-sm rounded-xl p-6 border border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between mb-6">
              ...
              <a href="/app/tasks?contact={contact.id}" class="text-sm text-blue-600 dark:text-blue-400 hover:underline">View all</a>
            </div>
            <div class="space-y-3">
        ...
        {#if contact.events && contact.events.length > 0}
          <div class="bg-white dark:bg-gray-800 shadow-sm rounded-xl p-6 border border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between mb-6">
              ...
              <a href="/app/events?contact={contact.id}" class="text-sm text-blue-600 dark:text-blue-400 hover:underline">View all</a>
            </div>
            <div class="space-y-3">
