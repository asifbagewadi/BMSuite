...
<div class="min-h-screen bg-white dark:bg-gray-800 dark:bg-gray-900 transition-colors">
  <!-- Header with Edit Button -->
  <div class="bg-white dark:bg-gray-800 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 dark:border-gray-700 sticky top-0 z-10">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
      <div class="flex justify-between items-center">
        <nav class="text-sm text-gray-500 dark:text-gray-400">
          <span>Admin</span> <span class="mx-2">/</span> <span>Blogs</span> <span class="mx-2">/</span> <span class="text-gray-900 dark:text-white dark:text-white">{data.blog?.title || 'Blog'}</span>
        </nav>
        <a
  ...
  <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <header class="text-center mb-12">
      ...
      <h1 class="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white dark:text-white mb-6 leading-tight">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
      ...
      <article class="lg:col-span-8 xl:col-span-9">
        <div class="prose prose-lg dark:prose-invert max-w-none">
          {#each data.blog?.contentBlocks || [] as block}
            <div class="mb-8">
              ...
              {#if block.type == "CODE"}
                <div class="my-6 rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 dark:border-gray-700">
        ...
        <!-- Share Section -->
        <div class="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700 dark:border-gray-700">
          <div class="bg-gray-50 dark:bg-gray-800 rounded-xl p-6">
            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
              <div class="flex items-center gap-2 text-gray-900 dark:text-white dark:text-white font-medium">
                <Share2 size={20} />
                Share this post
              </div>
      ...
      <aside class="lg:col-span-4 xl:col-span-3">
        <div class="sticky top-24">
          <div class="bg-gray-50 dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 dark:border-gray-700">
            <h3 class="font-semibold text-gray-900 dark:text-white dark:text-white mb-4">Blog Details</h3>
            <div class="space-y-3 text-sm">
              <div>
                <span class="text-gray-600 dark:text-gray-400 dark:text-gray-400">Type:</span>
                <span class="ml-2 text-gray-900 dark:text-white dark:text-white">Blog Post</span>
              </div>
              <div>
                <span class="text-gray-600 dark:text-gray-400 dark:text-gray-400">Status:</span>
...
<MetaTags
  ...
  titleTemplate="%s | BMSuite"
  description={data.blog?.seoDescription || 'Blog post'}
  canonical={"https://BMSuite.com/blog/" + (data.blog?.slug || '') + "/"}
  openGraph={{
    url: data.blog?.slug || '',
    title: data.blog?.seoTitle || 'Blog Post',
    description: data.blog?.seoDescription || 'Blog post',
    images: [
      {
        url: "https://BMSuite.com/images/logo.png",
        width: 800,
        height: 600,
        alt: "BMSuite - Open Source CRM Solution",
      },
    ],
    siteName: "BMSuite",
  }}
  twitter={{
    ...
    title: data.blog?.seoTitle || 'Blog Post',
    description: data.blog?.seoDescription || 'Blog post',
    image: "https://BMSuite.com/images/logo.png",
    imageAlt: "BMSuite - Open Source CRM Solution",
  }}
/>
